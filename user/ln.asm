...
main(int argc, char *argv[])
{
  ...
  14:	83058593          	addi	a1,a1,-2000 # 840 <malloc+0xea>
  18:	4509                	li	a0,2
  ...
  50:	80c58593          	addi	a1,a1,-2036 # 858 <malloc+0x102>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 408:	47450513          	addi	a0,a0,1140 # 878 <digits>
 40c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	3a8b8b93          	addi	s7,s7,936 # 878 <digits>
 ...
 614:	26090913          	addi	s2,s2,608 # 870 <malloc+0x11a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 82e:	b4e080e7          	jalr	-1202(ra) # 378 <sbrk>
  if(p == (char*)-1)
