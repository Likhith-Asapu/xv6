...
int main() {
  ...
  for(n=0; n < NFORK;n++) {
  12:	49a9                	li	s3,10
  14:	a805                	j	44 <main+0x44>
        settickets(400);
  16:	19000513          	li	a0,400
  1a:	00000097          	auipc	ra,0x0
  1e:	424080e7          	jalr	1060(ra) # 43e <settickets>
      else
        settickets(1);
      pid = fork();
  22:	00000097          	auipc	ra,0x0
  26:	354080e7          	jalr	852(ra) # 376 <fork>
      if (pid < 0)
  2a:	06054363          	bltz	a0,90 <main+0x90>
          break;
      if (pid == 0) {
  2e:	c11d                	beqz	a0,54 <main+0x54>
          }
  ...
  30:	4595                	li	a1,5
  32:	05000513          	li	a0,80
  36:	00000097          	auipc	ra,0x0
  3a:	410080e7          	jalr	1040(ra) # 446 <setpriority>
  for(n=0; n < NFORK;n++) {
  3e:	2485                	addiw	s1,s1,1
  40:	05348a63          	beq	s1,s3,94 <main+0x94>
    if(n == 8)
  44:	fd2489e3          	beq	s1,s2,16 <main+0x16>
        settickets(1);
  48:	4505                	li	a0,1
  4a:	00000097          	auipc	ra,0x0
  4e:	3f4080e7          	jalr	1012(ra) # 43e <settickets>
  52:	bfc1                	j	22 <main+0x22>
          if (n < IO) {
  54:	4791                	li	a5,4
  56:	0297d663          	bge	a5,s1,82 <main+0x82>
  5a:	3b9ad7b7          	lui	a5,0x3b9ad
  5e:	a0078793          	addi	a5,a5,-1536 # 3b9aca00 <base+0x3b9ab9f0>
            for (uint64 i = 0; i < 1000000000; i++) {} // CPU bound process 
  62:	17fd                	addi	a5,a5,-1
  64:	fffd                	bnez	a5,62 <main+0x62>
          printf("Process %d finished\n", n);
  66:	85a6                	mv	a1,s1
  68:	00001517          	auipc	a0,0x1
  6c:	86850513          	addi	a0,a0,-1944 # 8d0 <malloc+0xec>
  70:	00000097          	auipc	ra,0x0
  74:	6b6080e7          	jalr	1718(ra) # 726 <printf>
          exit(0);
  78:	4501                	li	a0,0
  7a:	00000097          	auipc	ra,0x0
  7e:	304080e7          	jalr	772(ra) # 37e <exit>
            sleep(200); // IO bound processes
  82:	0c800513          	li	a0,200
  86:	00000097          	auipc	ra,0x0
  8a:	388080e7          	jalr	904(ra) # 40e <sleep>
  8e:	bfe1                	j	66 <main+0x66>
#endif
      }
  }
  for(;n > 0; n--) {
  90:	02905b63          	blez	s1,c6 <main+0xc6>
  94:	4901                	li	s2,0
  96:	4981                	li	s3,0
  98:	a019                	j	9e <main+0x9e>
  9a:	34fd                	addiw	s1,s1,-1
  9c:	c49d                	beqz	s1,ca <main+0xca>
      if(waitx(0,&wtime,&rtime) >= 0) {
  9e:	fc840613          	addi	a2,s0,-56
  a2:	fcc40593          	addi	a1,s0,-52
  a6:	4501                	li	a0,0
  a8:	00000097          	auipc	ra,0x0
  ac:	37e080e7          	jalr	894(ra) # 426 <waitx>
  b0:	fe0545e3          	bltz	a0,9a <main+0x9a>
          trtime += rtime;
  b4:	fc842783          	lw	a5,-56(s0)
  b8:	0127893b          	addw	s2,a5,s2
          twtime += wtime;
  bc:	fcc42783          	lw	a5,-52(s0)
  c0:	013789bb          	addw	s3,a5,s3
  c4:	bfd9                	j	9a <main+0x9a>
  for(;n > 0; n--) {
  c6:	4901                	li	s2,0
  c8:	4981                	li	s3,0
      } 
  ...
  ca:	45a9                	li	a1,10
  cc:	02b9c63b          	divw	a2,s3,a1
  d0:	02b945bb          	divw	a1,s2,a1
  d4:	00001517          	auipc	a0,0x1
  d8:	81450513          	addi	a0,a0,-2028 # 8e8 <malloc+0x104>
  dc:	00000097          	auipc	ra,0x0
  e0:	64a080e7          	jalr	1610(ra) # 726 <printf>
  exit(0);
  e4:	4501                	li	a0,0
  e6:	00000097          	auipc	ra,0x0
  ea:	298080e7          	jalr	664(ra) # 37e <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 496:	47e50513          	addi	a0,a0,1150 # 910 <digits>
 49a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a2:	26a90913          	addi	s2,s2,618 # 908 <malloc+0x124>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8bc:	b4e080e7          	jalr	-1202(ra) # 406 <sbrk>
  if(p == (char*)-1)
