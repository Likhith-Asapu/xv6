...
int main(int argc, char *argv[])
{
  ...
  1a:	02a7dc63          	bge	a5,a0,52 <main+0x52>
    {
        printf("More than max arguments given\n");
  1e:	00001517          	auipc	a0,0x1
  22:	8aa50513          	addi	a0,a0,-1878 # 8c8 <malloc+0x112>
  26:	00000097          	auipc	ra,0x0
  2a:	6d2080e7          	jalr	1746(ra) # 6f8 <printf>
        exit(1);
  2e:	4505                	li	a0,1
  30:	00000097          	auipc	ra,0x0
  34:	320080e7          	jalr	800(ra) # 350 <exit>
        printf("Too few arguments passed to strace\n");
  38:	00001517          	auipc	a0,0x1
  3c:	86850513          	addi	a0,a0,-1944 # 8a0 <malloc+0xea>
  40:	00000097          	auipc	ra,0x0
  44:	6b8080e7          	jalr	1720(ra) # 6f8 <printf>
        exit(1);
  48:	4505                	li	a0,1
  4a:	00000097          	auipc	ra,0x0
  4e:	306080e7          	jalr	774(ra) # 350 <exit>
    {
  ...
  58:	1fc080e7          	jalr	508(ra) # 250 <atoi>
  5c:	00000097          	auipc	ra,0x0
  60:	394080e7          	jalr	916(ra) # 3f0 <trace>
  64:	04054163          	bltz	a0,a6 <main+0xa6>
  68:	01048593          	addi	a1,s1,16
  6c:	ee040713          	addi	a4,s0,-288
  70:	ffd9079b          	addiw	a5,s2,-3
  74:	1782                	slli	a5,a5,0x20
  76:	9381                	srli	a5,a5,0x20
  78:	078e                	slli	a5,a5,0x3
  7a:	ee840693          	addi	a3,s0,-280
  7e:	97b6                	add	a5,a5,a3
        exit(1);
    }
  ...
  86:	0721                	addi	a4,a4,8
  88:	fef71ce3          	bne	a4,a5,80 <main+0x80>
    }
    exec(command[0], command);
  8c:	ee040593          	addi	a1,s0,-288
  90:	ee043503          	ld	a0,-288(s0)
  94:	00000097          	auipc	ra,0x0
  98:	2f4080e7          	jalr	756(ra) # 388 <exec>
    exit(0);
  9c:	4501                	li	a0,0
  9e:	00000097          	auipc	ra,0x0
  a2:	2b2080e7          	jalr	690(ra) # 350 <exit>
        printf("strace failed\n");
  a6:	00001517          	auipc	a0,0x1
  aa:	84250513          	addi	a0,a0,-1982 # 8e8 <malloc+0x132>
  ae:	00000097          	auipc	ra,0x0
  b2:	64a080e7          	jalr	1610(ra) # 6f8 <printf>
        exit(1);
  b6:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 468:	49c50513          	addi	a0,a0,1180 # 900 <digits>
 46c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 534:	3d0b8b93          	addi	s7,s7,976 # 900 <digits>
 ...
 674:	28890913          	addi	s2,s2,648 # 8f8 <malloc+0x142>
        while(*s != 0){
